...
const Welcome = () => {
    return ( 
        <div id="About" className="xl:mx-principal nanomax:mx-0 lg:mx-principal2 lgmax:px-5  flex lgmax:flex-col mb-12 bg-blackcontainer rounded-lg p-4 lgmax:rounded-none">
