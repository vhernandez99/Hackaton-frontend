        ...
        <>
            <div className='mx-[20%] lgmax:mx-[5%]'>
                <div className='flex flex-col justify-center items-center'>
                    <h1 className='text-[4rem] font-extralight mb-6 lgmax:text-[2rem] lgmax:mt-8'>
                        {' '}
                        MEET THE TEAM{' '}
                    </h1>
                    ...
                    {members &&
                        members.map((member, index) => (
                            <div
                                key={index}
                                data-aos='zoom-in-up'
                                className='flex border-t-blue-600 border-t px-4 pt-2 lgmax:flex-col'>
                                ...
                                <div className='w-1/2 space-y-8 text-xl lgmax:w-full lgmax:space-y-4 lgmax:text-sm lgmax:mt-2'>
                                    <p className=''>
                                        {' '}
                                        <span>
                                            <a href=''>@tupapacrosfit</a>
                                        </span>{' '}
                                        Nearly two decades in Business{' '}
                                    </p>
                                    <p>
                                        {' '}
                                        Ranging from nightclub ownership and textiles management, to
                                        PR, marketing and movie production.
                                    </p>
                                    <p>
                                        {' '}
                                        Known as the celebrities go-to man, Leon has a top-notch,
                                        international network in all fields.
                                    </p>
                                </div>
                            </div>
                        ))}
